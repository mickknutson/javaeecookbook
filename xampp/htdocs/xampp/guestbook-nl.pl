...
if ($f_name) {
    open(FILE, ">>$gb") or die("kon bestand gastenboek niet openen");
...
print '<title>Gastenboek (Voorbeeld voor Perl)</title>';
print '</head>';

print '<body>';

print "<br><h1>Gastenboek (Voorbeeld voor Perl)</h1>";

print "<p>Een klassiek en simpel gastenboek!</p>";
...
while (!eof(FILE)) {
    ...
    print "Naam: ".CGI::escapeHTML($name);
    print "</td><td class='h'>";
    print "<img src='img/blank.gif' alt='' width='250' height='1'><br>";
...
print "<tr><td>Tekst:</td><td> <textarea rows='3' cols='30' name='f_text'></textarea></td></tr>";
print "<tr><td></td><td><input type='submit' value='SCHRIJF'></td></tr>";
print "</table>";
print "</form>";
