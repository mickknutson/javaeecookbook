...
print '<title>Gästebuch (Beispiel für Perl)</title>';
print '</head>';

print '<body>';

print "<br><h1>Gästebuch (Beispiel für Perl)</h1>\n";

print "<p>Ein ganz klassisches Gästebuch: von oben nach unten zeitlich die Beiträge!</p>";
...
print "<p>Eintrag hinzufügen:</p>";

print "<form action='guestbook-de.pl' method='get'>";
