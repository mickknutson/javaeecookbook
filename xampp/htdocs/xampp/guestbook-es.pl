...
if ($f_name) {
    open(FILE, ">>$gb") or die("No se puede abrir el fichero del Libro de Visitas");
...
print '<title>Libro de Visitas (Ejemplo de Perl)</title>';
print '</head>';

print '<body>';

print "<br><h1>Libro de Visitas (Ejemplo de Perl)</h1>";

print "<p>Un clasico y simple Libro de Visitas!</p>";
...
while (!eof(FILE)) {
    ...
    print "Nombre: ".CGI::escapeHTML($name);
    print "</td><td class='h'>";
    print "<img src='img/blank.gif' alt='' width='250' height='1'><br>";
...
print "<tr><td>Texto:</td><td> <textarea rows='3' cols='30' name='f_text'></textarea></td></tr>";
print "<tr><td></td><td><input type='submit' value='GRABAR'></td></tr>";
print "</table>";
print "</form>";
