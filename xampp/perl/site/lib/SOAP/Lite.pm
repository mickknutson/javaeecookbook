...
following in your webserver log file:
  ...
  Can't load '/xampp/lib/perl5/site_perl/.../XML/Parser/Expat/Expat.so'
    for module XML::Parser::Expat: dynamic linker: /xampp/perl/bin/perl.exe:
    libexpat.so.0 is NEEDED, but object does not exist at
    /xampp/lib/perl5/.../DynaLoader.pm line 200.
