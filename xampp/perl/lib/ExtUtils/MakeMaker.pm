...
would normally go into F</xampp/lib/perl> you could set DESTDIR=~/tmp/
and installation would go into F<~/tmp/xampp/lib/perl>.
...
#!/xampp/perl/bin/perl.exe MakeMaker will change this to the path of the perl
